...
24	CNN	<cnn index='1'/>	-1	{username}, you know what to do with the new hoax.				Sorry for the mind polution here. <br/>  Time to work!	You're learning so fast.	0	1					
25	Прaвда	Left-wing activists gathered in front of Congress aiming to extend <span class='keyword'>weekends<span class='tooltip'>Weekend is when people spend time on meaningless entertainments instead of coming to the lab to fulfil their experiments.</span></span> to be two days. <br/><br/> They claimed that if the chief scientist doesn't satify their need, they will refuse to admit that Experiment 65537 is better than Experiment 65536.	0	Activists are active again. <br/> What say you?	No wonder they call them Do Nothing Left.  <hr/> Make sense.	Incorrect. Wrong. False emotion. <hr/> You shouldn't have any empathy on those activists. <hr/> They are the unstabilizing factor of our society.	Would you kindly try again?									
...
34	Lorem Ipsum	Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.  <br/><br/> Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.	0	I think we already have enough facial muscle exercise today. <br/> Would you kindly accept this an automatic expression?												
